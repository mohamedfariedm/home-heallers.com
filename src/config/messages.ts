export const messages = {
  ...
  phoneNotFound: 'phone must begin with 05- --- --- -',
  ...
  catLenght: 'Category must be at least 3 letters',
  ...
  titleLengthMin: 'title must be at least 3 letters',
  descriptionLengthMin: 'description must be at least 3 letters',
  brandNameIsRequired: 'Brand Name is Required',
  permissionsRequired: 'At least one permission is required',
  brandNameLengthMin: 'Brand name must be at least 3 letters',
