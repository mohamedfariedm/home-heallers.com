...
export default function BenchmarkTable({ data = [], setSelectedColumns, getSelectedRowKeys,totalItems }: { data: any[], setSelectedColumns: React.Dispatch<React.SetStateAction<any[]>>, getSelectedRowKeys: React.Dispatch<React.SetStateAction<any[]>>, totalItems: number }) {
...
//   const [regionFilter, setRegionFilter] = useState([])
  ...
  const filterState = {
    ...
    offer_date: params.get('offer_date') || '',
