...
import { getColumns } from '@/app/shared/launched-model/columns';
import { useUsersByRole, useAllFilter } from '@/framework/settings';
const FilterElement = dynamic(
  () => import('@/app/shared/launched-model/filter-element'),
  { ssr: false }
);
...
export default function LaunchedModelTable({ data = [],totalItems, setSelectedColumns, getSelectedRowKeys }: { data: any[],totalItems:number ,setSelectedColumns: React.Dispatch<React.SetStateAction<any[]>>, getSelectedRowKeys: React.Dispatch<React.SetStateAction<any[]>> }) {
  ...
  const filterState = {
    ...
    availability_date_from: params.get('availability_date_from') || '',
    filter_region: params.get('filter_region') || '',
    availability_date_to: params.get('availability_date_to') || '',
