...
import { couponFormSchema, CouponFormInput } from '@/utils/validators/coupon-form.schema'; // schema for validation
import { Checkbox } from 'rizzui'; // Language toggle
import Spinner from '@/components/ui/spinner';
import { useCreateCoupons, useUpdateCoupons } from '@/framework/coupons';

export default function CreateOrUpdateCoupon({ initValues }: { initValues?: any }) {
