...
export default function SamplingModelTable({ data = [],totalItems, setSelectedColumns, getSelectedRowKeys }: { data: any[],totalItems: number, setSelectedColumns: React.Dispatch<React.SetStateAction<any[]>>, getSelectedRowKeys: React.Dispatch<React.SetStateAction<any[]>> }) {
  ...
  const filterState = {
    ...
    sampling_date_from: params.get('sampling_date_from') || '',
    sampling_date_to: params.get('sampling_date_to') || '',
