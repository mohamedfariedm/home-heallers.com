...
import { getColumns } from '@/app/shared/new-installed-soft-POSM/columns';
import { useUsersByRole, useAllFilter } from '@/framework/settings';
const FilterElement = dynamic(
  () => import('@/app/shared/new-installed-soft-POSM/filter-element'),
  { ssr: false }
);
...
export default function NewInstalledSoftPOSMTable({ data = [],totalItems, setSelectedColumns, getSelectedRowKeys }: { data: any[], totalItems:number, setSelectedColumns: React.Dispatch<React.SetStateAction<any[]>>, getSelectedRowKeys: React.Dispatch<React.SetStateAction<any[]>> }) {
