...
import { getColumns } from '@/app/shared/inqueries/columns';
...
const FilterElement = dynamic(
  () => import('@/app/shared/inqueries/filter-element'),
  { ssr: false }
);
...
export default function InqueriesTable({ data = [], getSelectedColumns, getSelectedRowKeys, totalItems }: { data: any[], getSelectedColumns: React.Dispatch<React.SetStateAction<any[]>>, getSelectedRowKeys: React.Dispatch<React.SetStateAction<any[]>>, totalItems: number }) {
