...
import { getColumns } from '@/app/shared/sales/columns';
import { useUsersByRole, useAllFilter } from '@/framework/settings';
const FilterElement = dynamic(
  () => import('@/app/shared/sales/filter-element'),
  { ssr: false }
);
...
export default function SalesTable({ data = [], setSelectedColumns, getSelectedRowKeys,totalItems }: { data: any[], setSelectedColumns: React.Dispatch<React.SetStateAction<any[]>>, getSelectedRowKeys: React.Dispatch<React.SetStateAction<any[]>>,totalItems: number }) {
