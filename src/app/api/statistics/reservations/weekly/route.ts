...
export async function GET(request: NextRequest) {
  try {
    ...
    const backendURL = new URL(`${API_BASE_URL}/api/statistics/reservations/weekly`);
    ...
    console.log('Fetching weekly from:', backendURL.toString());
    ...
    return NextResponse.json(
      { 
        ...
        data: { data: [], summary: { total_reservations: 0, total_weeks: 0, average_per_week: 0 } }
      },
      { status: 500 }
    );
  }
